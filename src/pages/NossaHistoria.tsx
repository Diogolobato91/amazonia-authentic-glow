      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <CardContent className="p-8 lg:p-12">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="relative">
                <img src="https://images.unsplash.com/photo-1518495973542-4542c06a5843?q=80&w=2070" alt="Floresta Amazônica - Nossa História" className="rounded-2xl shadow-amazonia w-full" onError={e => {
        ...
        <div className="mb-16">
          ...
          <div className="relative">
            ...
            <div className="space-y-8">
              ...
              return <div key={event.year} className={`flex items-center gap-8 ${index % 2 === 0 ? "flex-row" : "flex-row-reverse"}`}>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            return <Card key={value.title} className="text-center group hover:shadow-amazonia transition-all duration-300 hover:-translate-y-1 bg-card/80 backdrop-blur-sm border-border/50">
                  <CardContent className="p-6">
